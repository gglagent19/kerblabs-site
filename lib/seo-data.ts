...
export interface Location {
  ...
  // Geographic coordinates in decimal degrees (WGS84). Currently populated for
  // Tier 1 cities (25 UK + 5 US) to power GeoCoordinates blocks in Service
  // schema for stronger local-intent SEO signals.
  lat?: number;
  lng?: number;
}
...
export const locations: Location[] = [
  ...
  { name: "London", slug: "london", county: "Greater London", region: "London", tier: "tier1", areas: ["Shoreditch", "Hackney", "Clapham", "Islington", "Wimbledon"], character: "the UK's largest and most competitive market with 1.1 million small businesses", lat: 51.5074, lng: -0.1278 },
  { name: "Manchester", slug: "manchester", county: "Greater Manchester", region: "North West", tier: "tier1", areas: ["Northern Quarter", "Didsbury", "Chorlton", "Salford", "Trafford"], character: "the Northern Powerhouse capital with 130,000+ registered businesses and a fast-moving commercial culture", lat: 53.4808, lng: -2.2426 },
  { name: "Birmingham", slug: "birmingham", county: "West Midlands", region: "West Midlands", tier: "tier1", areas: ["Digbeth", "Jewellery Quarter", "Edgbaston", "Moseley", "Solihull"], character: "the UK's second city with 78,000+ SMEs and major HS2-driven regeneration", lat: 52.4862, lng: -1.8904 },
  { name: "Glasgow", slug: "glasgow", county: "Lanarkshire", region: "Scotland", tier: "tier1", areas: ["Merchant City", "West End", "Southside", "Pollokshields", "Govan"], character: "Scotland's largest city with 635k population and major post-industrial revival", lat: 55.8642, lng: -4.2518 },
  { name: "Leeds", slug: "leeds", county: "West Yorkshire", region: "Yorkshire and the Humber", tier: "tier1", areas: ["Headingley", "Chapel Allerton", "Roundhay", "Horsforth", "Morley"], character: "a major financial hub with three universities and growing professional sector", lat: 53.8008, lng: -1.5491 },
  { name: "Sheffield", slug: "sheffield", county: "South Yorkshire", region: "Yorkshire and the Humber", tier: "tier1", areas: ["Kelham Island", "Ecclesall Road", "Broomhill", "Hillsborough", "Crookes"], character: "a reinvented steel city with two universities and a creative tech quarter", lat: 53.3811, lng: -1.4701 },
  { name: "Edinburgh", slug: "edinburgh", county: "Lothian", region: "Scotland", tier: "tier1", areas: ["Leith", "Bruntsfield", "Morningside", "Stockbridge", "Marchmont"], character: "Scotland's capital with a major financial centre and significant tourism economy", lat: 55.9533, lng: -3.1883 },
  { name: "Bristol", slug: "bristol", county: "Somerset", region: "South West", tier: "tier1", areas: ["Clifton", "Stokes Croft", "Bedminster", "Redland", "Southville"], character: "the UK's most entrepreneurial city per capita with a health-conscious eco-aware demographic", lat: 51.4545, lng: -2.5879 },
  { name: "Liverpool", slug: "liverpool", county: "Merseyside", region: "North West", tier: "tier1", areas: ["Knowledge Quarter", "Baltic Triangle", "Allerton", "Woolton", "Crosby"], character: "a UNESCO city of music with revived maritime heritage and creative economy", lat: 53.4084, lng: -2.9916 },
  { name: "Nottingham", slug: "nottingham", county: "Nottinghamshire", region: "East Midlands", tier: "tier1", areas: ["Lace Market", "Hockley", "Beeston", "West Bridgford", "Mapperley"], character: "a city with two major universities and a growing tech sector", lat: 52.9548, lng: -1.1581 },
  { name: "Cardiff", slug: "cardiff", county: "Glamorgan", region: "Wales", tier: "tier1", areas: ["Pontcanna", "Canton", "Roath", "Cardiff Bay", "Cathays"], character: "the Welsh capital with growing tech and financial services sector", lat: 51.4816, lng: -3.1791 },
  { name: "Leicester", slug: "leicester", county: "Leicestershire", region: "East Midlands", tier: "tier1", areas: ["Belgrave Road", "Highfields", "Oadby", "Wigston", "Narborough Road"], character: "the UK's most diverse city with a strong multicultural community", lat: 52.6369, lng: -1.1398 },
  { name: "Newcastle", slug: "newcastle", county: "Tyne and Wear", region: "North East", tier: "tier1", areas: ["Quayside", "Ouseburn", "Jesmond", "Gosforth", "Heaton"], character: "a northeast hub with revived Quayside, two universities, and strong entrepreneurial culture", lat: 54.9783, lng: -1.6178 },
  { name: "Bradford", slug: "bradford", county: "West Yorkshire", region: "Yorkshire and the Humber", tier: "tier1", areas: ["Manningham", "Shipley", "Keighley", "Bingley", "Ilkley"], character: "the UK City of Culture 2025 with a diverse multicultural community", lat: 53.7960, lng: -1.7594 },
  { name: "Coventry", slug: "coventry", county: "West Midlands", region: "West Midlands", tier: "tier1", areas: ["Earlsdon", "Cheylesmore", "Binley", "Holbrooks", "Allesley"], character: "the UK City of Culture 2021 with two universities and automotive heritage", lat: 52.4068, lng: -1.5197 },
  { name: "Belfast", slug: "belfast", county: "County Antrim", region: "Northern Ireland", tier: "tier1", areas: ["Cathedral Quarter", "Titanic Quarter", "Botanic", "Stranmillis", "Ballyhackamore"], character: "a post-Troubles regenerating capital with growing tech and tourism", lat: 54.5973, lng: -5.9301 },
  { name: "Stoke-on-Trent", slug: "stoke-on-trent", county: "Staffordshire", region: "West Midlands", tier: "tier1", areas: ["Hanley", "Burslem", "Tunstall", "Stoke", "Longton"], character: "a six-towns city with ceramics heritage and ongoing regeneration", lat: 53.0027, lng: -2.1794 },
  { name: "Derby", slug: "derby", county: "Derbyshire", region: "East Midlands", tier: "tier1", areas: ["Cathedral Quarter", "Allestree", "Mickleover", "Spondon", "Chellaston"], character: "an industrial city with Rolls-Royce and Toyota employing engineering professionals", lat: 52.9225, lng: -1.4746 },
  { name: "Southampton", slug: "southampton", county: "Hampshire", region: "South East", tier: "tier1", areas: ["Ocean Village", "Bitterne", "Shirley", "Portswood", "Hedge End"], character: "a major port city with two universities and Ocean Village waterfront development", lat: 50.9097, lng: -1.4044 },
  { name: "Plymouth", slug: "plymouth", county: "Devon", region: "South West", tier: "tier1", areas: ["Barbican", "Mutley", "Plymstock", "Plympton", "Peverell"], character: "a naval city with HM Naval Base Devonport and a student population", lat: 50.3755, lng: -4.1427 },
  { name: "Reading", slug: "reading", county: "Berkshire", region: "South East", tier: "tier1", areas: ["Caversham", "Earley", "Woodley", "Tilehurst", "Calcot"], character: "the UK's Silicon Valley with high-income tech professionals from Microsoft, Oracle and Vodafone HQs", lat: 51.4543, lng: -0.9781 },
  { name: "Wolverhampton", slug: "wolverhampton", county: "West Midlands", region: "West Midlands", tier: "tier1", areas: ["Penn", "Finchfield", "Tettenhall", "Wednesfield", "Bilston"], character: "a Black Country city with diverse community and ongoing regeneration", lat: 52.5862, lng: -2.1281 },
  { name: "Swansea", slug: "swansea", county: "Glamorgan", region: "Wales", tier: "tier1", areas: ["Uplands", "Mumbles", "Sketty", "Gorseinon", "Port Talbot"], character: "the Welsh second city with a university and Swansea Bay City Deal investment", lat: 51.6214, lng: -3.9436 },
  { name: "Sunderland", slug: "sunderland", county: "Tyne and Wear", region: "North East", tier: "tier1", areas: ["Pallion", "Houghton-le-Spring", "Washington", "Seaham", "Hetton-le-Hole"], character: "a post-industrial northeast city with Nissan automotive base and Riverside regeneration", lat: 54.9069, lng: -1.3838 },
  { name: "Aberdeen", slug: "aberdeen", county: "Aberdeenshire", region: "Scotland", tier: "tier1", areas: ["Westhill", "Portlethen", "Stonehaven", "Inverurie", "Dyce"], character: "the oil capital of Europe with high-income energy sector workforce undergoing energy transition", lat: 57.1497, lng: -2.0943 },

  // ═══ TIER 1 — US LAUNCH CITIES (9) ═══
  ...
  // The 4 added FL cities (Tampa, Orlando, Jacksonville, Fort Lauderdale) round out the
  // Cohort 1 "5 Spa Sprint" footprint — same FL Board of Medicine medical-director rule applies.
  { name: "Miami", slug: "us-miami", county: "Miami-Dade County", region: "Florida", tier: "tier1", areas: ["Brickell", "Wynwood", "Coral Gables", "Coconut Grove", "South Beach"], character: "a Latin-American gateway city with a wealthy Brickell financial corridor, a creative Wynwood arts district and a bilingual aesthetics-led consumer market", country: "US", lat: 25.7617, lng: -80.1918 },
  { name: "Tampa", slug: "us-tampa", county: "Hillsborough County", region: "Florida", tier: "tier1", areas: ["Hyde Park", "South Tampa", "Westshore", "Channelside", "Wesley Chapel"], character: "a fast-growing Gulf Coast metro with a wealthy South Tampa / Hyde Park corridor, the Westshore business district and a heavy Tampa General / USF Health medical-professional density driving premium med-spa demand", country: "US", lat: 27.9506, lng: -82.4572 },
  { name: "Orlando", slug: "us-orlando", county: "Orange County", region: "Florida", tier: "tier1", areas: ["Winter Park", "Dr. Phillips", "Lake Nona", "Baldwin Park", "College Park"], character: "Central Florida's hospitality and tech capital with the affluent Winter Park / Dr. Phillips / Lake Nona corridor, AdventHealth medical hub presence, and a year-round event/tourism economy driving high-volume aesthetics demand", country: "US", lat: 28.5383, lng: -81.3792 },
  { name: "Jacksonville", slug: "us-jacksonville", county: "Duval County", region: "Florida", tier: "tier1", areas: ["San Marco", "Riverside", "Avondale", "Ponte Vedra Beach", "Mandarin"], character: "Florida's most populous city geographically with the affluent Ponte Vedra Beach / San Marco / Avondale corridor, Mayo Clinic Jacksonville medical authority anchor, and a military-and-finance professional base driving stable aesthetics demand", country: "US", lat: 30.3322, lng: -81.6557 },
  { name: "Fort Lauderdale", slug: "us-fort-lauderdale", county: "Broward County", region: "Florida", tier: "tier1", areas: ["Las Olas", "Victoria Park", "Coral Ridge", "Rio Vista", "Wilton Manors"], character: "the South Florida yachting capital with the Las Olas / Victoria Park / Coral Ridge waterfront corridor, a strong LGBTQ+ Wilton Manors aesthetic-friendly community, and Broward County's bilingual English/Spanish search market layered beneath Miami's", country: "US", lat: 26.1224, lng: -80.1373 },
  { name: "New York City", slug: "us-new-york-city", county: "New York County", region: "New York", tier: "tier1", areas: ["Manhattan", "Brooklyn", "Queens", "Upper East Side", "Williamsburg"], character: "the United States' densest small-business market, where Manhattan and Brooklyn med spas compete in a fiercely review-driven, search-first consumer environment regulated by the NY Department of State", country: "US", lat: 40.7128, lng: -74.0060 },
  { name: "Los Angeles", slug: "us-los-angeles", county: "Los Angeles County", region: "California", tier: "tier1", areas: ["Beverly Hills", "West Hollywood", "Santa Monica", "Downtown LA", "Pasadena"], character: "the global capital of aesthetic medicine with a Beverly Hills / West Hollywood / Santa Monica corridor of physician-supervised med spas competing on celebrity-grade reviews and Instagram-led discovery", country: "US", lat: 34.0522, lng: -118.2437 },
  { name: "Chicago", slug: "us-chicago", county: "Cook County", region: "Illinois", tier: "tier1", areas: ["Lincoln Park", "River North", "West Loop", "Gold Coast", "Lakeview"], character: "the Midwestern flagship metro with a Lincoln Park / River North / West Loop med-spa belt regulated by the Illinois Department of Financial and Professional Regulation", country: "US", lat: 41.8781, lng: -87.6298 },
  { name: "Houston", slug: "us-houston", county: "Harris County", region: "Texas", tier: "tier1", areas: ["River Oaks", "The Heights", "Memorial", "Montrose", "Uptown"], character: "the fourth-largest US city with a River Oaks / The Heights / Memorial premium aesthetics market overseen by the Texas Medical Board and a Latina-led consumer demographic driving rapid med-spa growth", country: "US", lat: 29.7604, lng: -95.3698 },
